...
export const IT_SCENARIOS: Scenario[] = [
    ...
    mcqs: [
      {
        ...
        options: [
          { target: 'Vorrei un caffè, per favore.', correct: true },
          { target: 'Mi chiamo Marco.', correct: false },
          { target: 'Sono le tre.', correct: false },
        ],
        hint: 'vorrei + [chose] = façon polie de commander',
      },
    ],
    conjugation: [
      { id: 'it-essere-io-presente', verb: 'essere', tense: 'presente', prompt: 'io ___ italiano', options: ['sono', 'sei', 'è'], answer: 'sono' },
      { id: 'it-essere-tu-presente', verb: 'essere', tense: 'presente', prompt: 'tu ___ di Roma?', options: ['sei', 'sono', 'è'], answer: 'sei' },
    ],
  },
  {
    id: 'it-presentarsi',
    ...
    mcqs: [
      {
        ...
        options: [
          { target: 'Mi chiamo Alex.', correct: true },
          { target: 'Ho vent’anni.', correct: false },
          { target: 'Vado al bar.', correct: false },
        ],
        hint: 'mi chiamo = ma présentation, pas mon âge ni ma destination',
      },
    ],
    conjugation: [
      { id: 'it-avere-io-presente', verb: 'avere', tense: 'presente', prompt: 'io ___ vent’anni', options: ['ho', 'hai', 'ha'], answer: 'ho' },
      { id: 'it-avere-tu-presente', verb: 'avere', tense: 'presente', prompt: 'tu ___ un fratello?', options: ['hai', 'ho', 'ha'], answer: 'hai' },
      { id: 'it-essere-tu-presente', verb: 'essere', tense: 'presente', prompt: 'tu ___ di Roma?', options: ['sei', 'sono', 'è'], answer: 'sei' },
    ],
  },
  {
    ...
    mcqs: [
      {
        ...
        options: [
          { target: 'Scusi, dov’è la stazione?', correct: true },
          { target: 'Mi chiamo Marco.', correct: false },
          { target: 'Vorrei un caffè.', correct: false },
        ],
        hint: 'dov’è = pour localiser quelque chose',
      },
    ],
    conjugation: [
      { id: 'it-andare-io-presente', verb: 'andare', tense: 'presente', prompt: 'io ___ al lavoro', options: ['vado', 'vai', 'va'], answer: 'vado' },
      { id: 'it-andare-tu-presente', verb: 'andare', tense: 'presente', prompt: 'tu ___ a piedi?', options: ['vai', 'vado', 'va'], answer: 'vai' },
      { id: 'it-avere-io-presente', verb: 'avere', tense: 'presente', prompt: 'io ___ vent’anni', options: ['ho', 'hai', 'ha'], answer: 'ho' },
      { id: 'it-essere-tu-presente', verb: 'essere', tense: 'presente', prompt: 'tu ___ di Roma?', options: ['sei', 'sono', 'è'], answer: 'sei' },
    ],
  },
    ...
    mcqs: [
      {
        ...
        options: [
          { target: 'Sì, un tavolo per due, per favore.', correct: true },
          { target: 'Sono di Parigi.', correct: false },
          { target: 'È sempre dritto.', correct: false },
        ],
        hint: 'avete prenotato? = question sur la réservation, réponds-y directement',
      },
    ],
    conjugation: [
      { id: 'it-volere-io-presente', verb: 'volere', tense: 'presente', prompt: 'io ___ il conto', options: ['voglio', 'vuoi', 'vuole'], answer: 'voglio' },
      { id: 'it-volere-tu-presente', verb: 'volere', tense: 'presente', prompt: 'tu ___ prenotare?', options: ['vuoi', 'voglio', 'vuole'], answer: 'vuoi' },
      { id: 'it-andare-io-presente', verb: 'andare', tense: 'presente', prompt: 'io ___ al lavoro', options: ['vado', 'vai', 'va'], answer: 'vado' },
      { id: 'it-avere-tu-presente', verb: 'avere', tense: 'presente', prompt: 'tu ___ un fratello?', options: ['hai', 'ho', 'ha'], answer: 'hai' },
    ],
  },
    ...
    mcqs: [
      {
        ...
        options: [
          { target: 'Sì, vorrei un chilo di pomodori.', correct: true },
          { target: 'Devo andare alla stazione.', correct: false },
          { target: 'Sto molto bene, grazie.', correct: false },
        ],
        hint: 'On répond à une offre d’aide en disant ce qu’on veut',
      },
    ],
    conjugation: [
      { id: 'it-potere-io-presente', verb: 'potere', tense: 'presente', prompt: 'io ___ pagare con la carta?', options: ['posso', 'puoi', 'può'], answer: 'posso' },
      { id: 'it-potere-tu-presente', verb: 'potere', tense: 'presente', prompt: 'tu ___ aiutarmi?', options: ['puoi', 'posso', 'può'], answer: 'puoi' },
      { id: 'it-andare-io-presente', verb: 'andare', tense: 'presente', prompt: 'io ___ al lavoro', options: ['vado', 'vai', 'va'], answer: 'vado' },
      { id: 'it-avere-tu-presente', verb: 'avere', tense: 'presente', prompt: 'tu ___ un fratello?', options: ['hai', 'ho', 'ha'], answer: 'hai' },
    ],
  },
    ...
    mcqs: [
      {
        ...
        options: [
          { target: 'Devo andare alla stazione centrale.', correct: true },
          { target: 'Posso aiutarla?', correct: false },
          { target: 'Vorrei un chilo di pomodori.', correct: false },
        ],
        hint: 'devo + [destination] = pour dire où on doit aller',
      },
    ],
    conjugation: [
      { id: 'it-dovere-io-presente', verb: 'dovere', tense: 'presente', prompt: 'io ___ partire alle otto', options: ['devo', 'devi', 'deve'], answer: 'devo' },
      { id: 'it-dovere-tu-presente', verb: 'dovere', tense: 'presente', prompt: 'tu ___ cambiare treno?', options: ['devi', 'devo', 'deve'], answer: 'devi' },
      { id: 'it-potere-io-presente', verb: 'potere', tense: 'presente', prompt: 'io ___ pagare con la carta?', options: ['posso', 'puoi', 'può'], answer: 'posso' },
      { id: 'it-volere-tu-presente', verb: 'volere', tense: 'presente', prompt: 'tu ___ prenotare?', options: ['vuoi', 'voglio', 'vuole'], answer: 'vuoi' },
    ],
  },
  {
    ...
    mcqs: [
      {
        ...
        options: [
          { target: 'Faccio una riunione importante.', correct: true },
          { target: 'Devo partire alle otto.', correct: false },
          { target: 'Posso aiutarla?', correct: false },
        ],
    ...
    conjugation: [
      { id: 'it-fare-io-presente', verb: 'fare', tense: 'presente', prompt: 'io ___ colazione presto', options: ['faccio', 'fai', 'fa'], answer: 'faccio' },
      { id: 'it-fare-tu-presente', verb: 'fare', tense: 'presente', prompt: 'tu ___ sport?', options: ['fai', 'faccio', 'fa'], answer: 'fai' },
      { id: 'it-dovere-io-presente', verb: 'dovere', tense: 'presente', prompt: 'io ___ partire alle otto', options: ['devo', 'devi', 'deve'], answer: 'devo' },
      { id: 'it-volere-io-presente', verb: 'volere', tense: 'presente', prompt: 'io ___ il conto', options: ['voglio', 'vuoi', 'vuole'], answer: 'voglio' },
    ],
  },
    ...
    mcqs: [
      {
        ...
        options: [
          { target: 'Non sto molto bene, ho mal di testa.', correct: true },
          { target: 'Faccio una riunione importante.', correct: false },
          { target: 'Un biglietto costa due euro.', correct: false },
        ],
        hint: 'sto bene/male = pour décrire son état de santé du moment',
      },
    ],
    conjugation: [
      { id: 'it-stare-io-presente', verb: 'stare', tense: 'presente', prompt: 'io non ___ bene', options: ['sto', 'stai', 'sta'], answer: 'sto' },
      { id: 'it-stare-tu-presente', verb: 'stare', tense: 'presente', prompt: 'tu ___ meglio oggi?', options: ['stai', 'sto', 'sta'], answer: 'stai' },
      { id: 'it-fare-io-presente', verb: 'fare', tense: 'presente', prompt: 'io ___ colazione presto', options: ['faccio', 'fai', 'fa'], answer: 'faccio' },
      { id: 'it-essere-io-presente', verb: 'essere', tense: 'presente', prompt: 'io ___ italiano', options: ['sono', 'sei', 'è'], answer: 'sono' },
    ],
  },
