...
var candidateFeeds = []Feed{
	...
	{Name: "Fresh Air (NPR)", URL: "https://feeds.npr.org/381444908/podcast.xml", Lang: "en", Level: "native"},
	{Name: "Ear Hustle", URL: "https://feeds.earhustlesq.com/earhustlesq", Lang: "en", Level: "native"},
	{Name: "The Moment with Jorge Ramos and Paola Ramos", URL: "https://www.omnycontent.com/d/playlist/e73c998e-6e60-432f-8610-ae210140c5b1/759cedb2-b3e2-4407-a599-b34d00fb38a6/bffd2c26-6b20-4ca7-bf31-b34d00fb3cab/podcast.rss", Lang: "en", Level: "native"},
	...
	{Name: "Central (Radio Ambulante Studios)", URL: "https://www.omnycontent.com/d/playlist/e73c998e-6e60-432f-8610-ae210140c5b1/0367bfd5-c9a2-4b46-b584-b1ea013507bc/50dacf3a-5b3c-4655-bae4-b1ea013507ef/podcast.rss", Lang: "es", Level: "native"},
	...
	{Name: "Italiano Automatico", URL: "https://italianoautomatico.podomatic.com/rss2.xml", Lang: "it", Level: "learner_beginner"},
	{Name: "Italy Made Easy (100% in Italiano)", URL: "https://feed.pod.co/italy-made-easy-podcast", Lang: "it", Level: "learner_intermediate"},
	// NB : les transcripts de ce flux sont marqués language="en" alors que le
	// contenu audio est en italien (format "Easy Languages" : interviews IT +
	// narration EN) — à vérifier manuellement avant de compter ce flux comme
	// exploitable pour la révision italienne.
	{Name: "Easy Italian (Spreaker)", URL: "https://www.spreaker.com/show/6604621/episodes/feed", Lang: "it", Level: "learner_beginner"},
}
